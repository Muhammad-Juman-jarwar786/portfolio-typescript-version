  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          As a dedicated front-end developer, freelancer, and entrepreneur, I’m
          always eager to collaborate and bring ideas to life. If you’re
          interested in my work or have a project in mind, please don’t hesitate
          to reach out. Fill out the form below, and I’ll be sure to respond to
          your email. Let’s create something amazing together!
        </motion.p>
      </div>
      <div className="flex justify-center items-center min-h-screen bg-[#050816] mt-10 lg:pt-14">
